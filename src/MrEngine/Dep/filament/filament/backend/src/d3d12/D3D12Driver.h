...
namespace filament
{
	namespace backend
	{
		...
		class D3D12Driver final : public DriverBase
		{
		public:
			static Driver* create(backend::D3D12Platform* platform);

		private:
			explicit D3D12Driver(backend::D3D12Platform* platform) noexcept;
			~D3D12Driver() noexcept override;
...
#include "private/backend/DriverAPI.inc"
		...
		private:
			backend::D3D12Platform& m_platform;
