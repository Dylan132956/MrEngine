...
namespace moonriver
{
    void metaExample()
    {
        ...
        //readPointer Cause memory leak
        delete test1_out.m_int_vector[0];
        ...
        //readPointer Cause memory leak
        delete fields;
        Test1* pTest = (Test1*)test2_out.m_test_base_array[0].getPtr();
        delete pTest->m_int_vector[0];
		delete test2_out.m_test_base_array[0].getPtr();
		delete test2_out.m_test_base_array[1].getPtr();
    }
} // namespace moonriver
