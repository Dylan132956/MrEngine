...
namespace moonriver
{
	...
	Quaternion Quaternion::LookRotation(const Vector3& forward, const Vector3& up)
	{
        ...
        Vector3 right = un * fn;
        Vector3 up0 = fn * right;
        
        Quaternion rot0 = Quaternion::FromToRotation(Vector3(0, 0, 1), fn);
        Vector3 up1 = rot0 * Vector3(0, 1, 0);
        Quaternion rot1 = Quaternion::FromToRotation(up1, up0);
